...
const mountCaptchaScript = (params = {}) => {
  ...
  // script.src = `${domain}/1/api.js?render=explicit&onload=hcaptchaOnLoad?test=test2`;
  script.src = '../HCaptcha.js?render=explicit&onload=hcaptchaOnLoad?test=test1';
  script.async = true;
...
class HCaptcha extends React.Component {
  ...
  componentDidMount() { // Once captcha is mounted intialize hCaptcha - hCaptcha
    const {
      apihost, assethost, endpoint, host, imghost, languageOverride: hl, reCaptchaCompat, reportapi, sentry, custom
    } = this.props;
  ...
  render() {
    ...
    return <div ref={this.ref} id={elementId} />;
  }
}
